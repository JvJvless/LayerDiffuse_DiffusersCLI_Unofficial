...
positive_tags = "a old man, high quality"
...
with torch.inference_mode():
    ...
    cond_1 = load_condiction("./images/bg1.png")
#     cond = load_condiction("./results/bg.png")

    cond_2 = load_condiction("./results/bg2ble_0_transparent.png")
    ...
    for i, image in enumerate(result_list):
        Image.fromarray(image).save(f"./results/bg+blend2fg_{i}_transparent.png", format="PNG")
